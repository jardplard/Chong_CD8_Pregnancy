...
GSEAres.SPP5N <- results(dseq, contrast=c("condition","SPP_C5","Naive"), cooksCutoff=FALSE, independentFiltering=FALSE)
...
GseaSPP5N <- genListGSEA(GSEAres.SPP5N)
write.table(GseaSPP5N, file=paste("CD8_GseaSPP5n", ".rnk", sep=""), col.names=FALSE, row.names=FALSE, quote=FALSE, sep='\t')
...
GseaSPP5SUB_cluster4 <- GseaSPP5SUB %>% filter(genename %in% str_to_upper(GeneList_hmcluster4$genename))
GseaSPP5SUB_cluster4 <- GseaSPP5SUB_cluster4 %>% arrange(desc(change_metric))
write.table(GseaSPP5SUB_cluster4, file=paste("CD8_GseaSPP5SUB_cluster4", ".rnk"), col.names=FALSE, row.names=FALSE, quote=FALSE, sep='\t')
